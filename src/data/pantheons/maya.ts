    ...
    challenges: [
      {
        ...
        domain: 'wisdom',
        tier: 'challenging',
        requirement: { type: 'kill_elites', value: 5, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'wisdom',
        tier: 'heroic',
        requirement: { type: 'kill_monsters', value: 12, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'life',
        tier: 'challenging',
        requirement: { type: 'heal_self', value: 5, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
    ...
    challenges: [
      {
        ...
        domain: 'sky',
        tier: 'challenging',
        requirement: { type: 'melee_kills', value: 400, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
  ...
  // ===== KUKULKAN - Knowledge Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'knowledge',
        tier: 'legendary',
        requirement: { type: 'kill_elites', value: 1, timeLimit: 8 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
    ...
    challenges: [
      {
        ...
        domain: 'death',
        tier: 'challenging',
        requirement: { type: 'floor_clear', value: 9, timeLimit: 9 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'death',
        tier: 'legendary',
        requirement: { type: 'kill_monsters', value: 3, timeLimit: 9 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
    ...
    challenges: [
      {
        ...
        domain: 'war',
        tier: 'challenging',
        requirement: { type: 'kill_monsters', value: 3, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'war',
        tier: 'legendary',
        requirement: { type: 'kill_bosses', value: 3, timeLimit: 9 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
    ...
    challenges: [
      {
        ...
        domain: 'trickery',
        tier: 'challenging',
        requirement: { type: 'floor_clear', value: 8, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
  ...
  // ===== YUM KAAX - Nature Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'nature',
        tier: 'heroic',
        requirement: { type: 'kill_monsters', value: 5, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
  ...
  // ===== BULUC CHABTAN - War Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'war',
        tier: 'legendary',
        requirement: { type: 'melee_kills', value: 15, timeLimit: 9 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
    ...
    challenges: [
      {
        ...
        domain: 'fortune',
        tier: 'challenging',
        requirement: { type: 'gold_collected', value: 800, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'fortune',
        tier: 'heroic',
        requirement: { type: 'item_found', value: 4, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
  ...
  // ===== XMUCANE - Magic Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'magic',
        tier: 'heroic',
        requirement: { type: 'kill_monsters', value: 1200, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'death',
        tier: 'heroic',
        requirement: { type: 'kill_monsters', value: 5, timeLimit: 6 },
        favorGain: 20,
        favorLoss: 10,
      },
      {
        ...
        domain: 'death',
        tier: 'legendary',
        requirement: { type: 'floor_clear', value: 3, timeLimit: 9 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
