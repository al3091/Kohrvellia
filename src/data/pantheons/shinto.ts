  ...
  // ===== KONOHANASAKUYA-HIME - Nature Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'nature',
        tier: 'heroic',
        requirement: { type: 'floor_clear', value: 3, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'craft',
        tier: 'challenging',
        requirement: { type: 'floor_clear', value: 3, timeLimit: 3 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'craft',
        tier: 'heroic',
        requirement: { type: 'floor_clear', value: 8, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'authority',
        tier: 'challenging',
        requirement: { type: 'melee_kills', value: 5, timeLimit: 3 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'authority',
        tier: 'legendary',
        requirement: { type: 'floor_clear', value: 10, timeLimit: 10 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
    ...
    challenges: [
      {
        ...
        domain: 'magic',
        tier: 'heroic',
        requirement: { type: 'kill_elites', value: 5, timeLimit: 6 },
        favorGain: 20,
        favorLoss: 10,
      },
      {
        ...
        domain: 'magic',
        tier: 'legendary',
        requirement: { type: 'kill_monsters', value: 5, timeLimit: 9 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
    ...
    challenges: [
      {
        ...
        domain: 'sea',
        tier: 'challenging',
        requirement: { type: 'kill_monsters', value: 8, timeLimit: 3 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'sea',
        tier: 'heroic',
        requirement: { type: 'melee_kills', value: 1, timeLimit: 6 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'war',
        tier: 'challenging',
        requirement: { type: 'floor_clear', value: 7, timeLimit: 7 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'war',
        tier: 'heroic',
        requirement: { type: 'melee_kills', value: 500, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'sky',
        tier: 'heroic',
        requirement: { type: 'kill_monsters', value: 800, timeLimit: 7 },
        favorGain: 20,
        favorLoss: 10,
      },
      {
        ...
        domain: 'sky',
        tier: 'legendary',
        requirement: { type: 'kill_bosses', value: 1, timeLimit: 9 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
    ...
    challenges: [
      {
        ...
        domain: 'life',
        tier: 'heroic',
        requirement: { type: 'floor_clear', value: 5, timeLimit: 7 },
        favorGain: 20,
        favorLoss: 10,
      },
      {
        ...
        domain: 'life',
        tier: 'challenging',
        requirement: { type: 'heal_self', value: 500, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
    ],
    ...
    challenges: [
      {
        ...
        domain: 'death',
        tier: 'heroic',
        requirement: { type: 'melee_kills', value: 10, timeLimit: 6 },
        favorGain: 20,
        favorLoss: 10,
      },
      {
  ...
  // ===== OOMIWA - Wisdom Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'wisdom',
        tier: 'heroic',
        requirement: { type: 'kill_monsters', value: 1, timeLimit: 6 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'fortune',
        tier: 'challenging',
        requirement: { type: 'kill_monsters', value: 10, timeLimit: 3 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'fortune',
        tier: 'legendary',
        requirement: { type: 'item_found', value: 3, timeLimit: 9 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
    ...
    challenges: [
      {
        ...
        domain: 'sky',
        tier: 'challenging',
        requirement: { type: 'kill_monsters', value: 3, timeLimit: 3 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'sky',
        tier: 'legendary',
        requirement: { type: 'kill_monsters', value: 8, timeLimit: 9 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
    ...
    challenges: [
      {
        ...
        domain: 'war',
        tier: 'challenging',
        requirement: { type: 'melee_kills', value: 300, timeLimit: 3 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'war',
        tier: 'legendary',
        requirement: { type: 'melee_kills', value: 10, timeLimit: 9 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
    ...
    challenges: [
      {
        ...
        domain: 'trickery',
        tier: 'challenging',
        requirement: { type: 'floor_clear', value: 15, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'trickery',
        tier: 'heroic',
        requirement: { type: 'melee_kills', value: 5, timeLimit: 6 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
