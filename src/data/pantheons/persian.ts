  ...
  // ===== ANAHITA - Life Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'life',
        tier: 'heroic',
        requirement: { type: 'heal_self', value: 1, timeLimit: 6 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
  ...
  // ===== VAYU - War Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'war',
        tier: 'heroic',
        requirement: { type: 'melee_kills', value: 50, timeLimit: 6 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'fortune',
        tier: 'challenging',
        requirement: { type: 'item_found', value: 10, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
  ...
  // ===== RASHNU - Knowledge Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'knowledge',
        tier: 'challenging',
        requirement: { type: 'melee_kills', value: 3, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
    ],
  ...
  // ===== SRAOSHA - Magic Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'magic',
        tier: 'heroic',
        requirement: { type: 'kill_monsters', value: 1000, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
  ...
  // ===== VERETHRAGNA - War Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'war',
        tier: 'legendary',
        requirement: { type: 'melee_kills', value: 5, timeLimit: 9 },
        favorGain: 30,
        bonusStatPoints: 3,
        favorLoss: 15,
      },
  ...
  // ===== HAOMA - Craft Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'craft',
        tier: 'heroic',
        requirement: { type: 'kill_elites', value: 3, timeLimit: 6 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
