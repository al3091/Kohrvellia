    ...
    challenges: [
      {
        ...
        domain: 'war',
        tier: 'challenging',
        requirement: { type: 'melee_kills', value: 20, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'war',
        tier: 'heroic',
        requirement: { type: 'kill_bosses', value: 2, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
  ...
  // ===== SHANGO - Sky Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'sky',
        tier: 'heroic',
        requirement: { type: 'floor_clear', value: 1, timeLimit: 6 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'fortune',
        tier: 'challenging',
        requirement: { type: 'gold_collected', value: 10, timeLimit: 5 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
  ...
  // ===== YEMOJA - Sea Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'sea',
        tier: 'heroic',
        requirement: { type: 'floor_clear', value: 25, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
  ...
  // ===== OBATALA - Wisdom Domain =====
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        domain: 'wisdom',
        tier: 'heroic',
        requirement: { type: 'kill_bosses', value: 1, timeLimit: 6 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'knowledge',
        tier: 'challenging',
        requirement: { type: 'kill_monsters', value: 10, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
    ...
    challenges: [
      {
        ...
        domain: 'trickery',
        tier: 'challenging',
        requirement: { type: 'floor_clear', value: 15, timeLimit: 3 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'trickery',
        tier: 'heroic',
        requirement: { type: 'kill_elites', value: 3, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'death',
        tier: 'challenging',
        requirement: { type: 'kill_monsters', value: 20, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
    ...
    challenges: [
      {
        ...
        domain: 'nature',
        tier: 'challenging',
        requirement: { type: 'heal_self', value: 200, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'nature',
        tier: 'heroic',
        requirement: { type: 'item_found', value: 5, timeLimit: 3 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'nature',
        tier: 'challenging',
        requirement: { type: 'kill_beasts', value: 15, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
    ...
    challenges: [
      {
        ...
        domain: 'life',
        tier: 'challenging',
        requirement: { type: 'heal_self', value: 100, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
    ...
    challenges: [
      {
        ...
        domain: 'fire',
        tier: 'challenging',
        requirement: { type: 'melee_kills', value: 15, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'fire',
        tier: 'heroic',
        requirement: { type: 'melee_kills', value: 300, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
    ...
    challenges: [
      {
        ...
        domain: 'sea',
        tier: 'challenging',
        requirement: { type: 'item_found', value: 5, timeLimit: 4 },
        favorGain: 15,
        favorLoss: 8,
      },
      {
        ...
        domain: 'sea',
        tier: 'heroic',
        requirement: { type: 'item_found', value: 1, timeLimit: 7 },
        favorGain: 25,
        bonusStatPoints: 2,
        favorLoss: 12,
      },
