...
- **Current batch:** **B-10 step 2** then **B-12** (dual-stat finish) — **TODO**. B-10 step 2 = the challenge favor-set routing + tier collapse + reward targeting above. **Riding later: B-08 lint-gate · B-13 (373 combat triangle) · B-09 step 4b.**
