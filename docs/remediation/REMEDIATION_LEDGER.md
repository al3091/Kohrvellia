...
- **B-10 step 2 DONE** (`736c1ba`): all 3 LIVE challenge favor-sets routed through `adjustFavor` (**180 closed**) — every live favor path now syncs the character + triggers eviction consistently. **B-10 step 3 (small tail/riders): FAVOR_TIERS collapse + challenge-reward targeting (122/123/079/215/126) + the dead `tickChallengeFloor` (→B-22).**
